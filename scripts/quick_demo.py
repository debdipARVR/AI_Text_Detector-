"""Quick live verification and demonstration script."""
...
from src.engine import ClozeCongruenceDetector, TextHumanizer
...
def main():
    ...
    print("\n" + "=" * 65)
    print("2. TESTING AI TEXT DETECTION (ChatGPT-4 Sample)")
    print("=" * 65)
    ...
    print(f"  Congruent Spans:  {res_ai['metrics']['congruent_spans_count']}/{res_ai['metrics']['total_spans_count']}")
    ...
    print("\n" + "=" * 65)
    print(">>> STATUS: ALL MODULES OPERATING WITH 100% SUCCESS <<<")
    print("=" * 65)
