...
PRESETS = {
    "Jawaharlal Nehru: Architect of Modern India": (
        ...
        "During his stay in England, he was exposed to liberal ideas, democratic values, and the political movements taking place across Europe. "
        "These experiences greatly influenced his thinking and later shaped his vision for India.\n\n"
        "After returning to India in 1912, Nehru began practicing law in Allahabad. "
        "However, he soon realized that his true calling was not the courtroom but the service of the nation. "
        "The political atmosphere in India was changing rapidly under British rule, and Nehru felt compelled to join the struggle for independence. "
        "His meeting with Mahatma Gandhi in 1916 marked a turning point in his life. "
        "Inspired by Gandhi's ideals of truth, non-violence, and civil disobedience, Nehru dedicated himself wholeheartedly to the Indian freedom movement.\n\n"
        "Jawaharlal Nehru actively participated in several important movements launched by the Indian National Congress. "
        "He took part in the Non-Cooperation Movement (1920–22), the Civil Disobedience Movement (1930–34), and the Quit India Movement (1942). "
        "Throughout these movements, he was arrested and imprisoned by the British government many times. "
        "In total, he spent nearly nine years in prison. "
        "Despite imprisonment and hardships, Nehru never gave up his fight for freedom. "
        "Instead, he used his time in jail to read extensively and write books that reflected his deep understanding of history, politics, and civilization.\n\n"
        "India finally achieved independence on 15 August 1947, after nearly two centuries of British rule. "
        "Jawaharlal Nehru became the first Prime Minister of independent India. "
        "His historic speech, 'Tryst with Destiny,' delivered at midnight on the eve of independence, remains one of the greatest speeches in history. "
        "In this speech, he spoke about India's responsibility to build a just, peaceful, and prosperous nation. "
        "His words inspired hope and confidence among millions of Indians who looked forward to a brighter future."
    ),
